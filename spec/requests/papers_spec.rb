...
RSpec.describe "/papers", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      Paper.create!(title: "a",venue: "b",year: 3)
      get papers_url
  ...
  describe "GET /show" do
    it "renders a successful response" do
      paper = Paper.create!(title: "a",venue: "b",year: 3)
      get paper_url(paper)
      expect(response).to be_successful
    end
  end
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Paper" do
        expect {
          post papers_url, params: { paper: {title: "a", venue:"b", year: 3} }
    ...
    context "with invalid parameters" do
      it "does not create a new Paper" do
        expect {
          post papers_url, params: { paper: {title: "a",venue: "b"} }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested paper" do
        paper = Paper.create!(title: "a",venue: "b",year: 3)
        patch paper_url(paper), params: { paper: {title: "b",venue: "c",year: 4} }
        paper.reload
      ...
      it "redirects to the paper" do
        paper = Paper.create!(title: "a",venue: "b",year: 3)
        patch paper_url(paper), params: { paper: {title: "b",venue: "c",year: 2} }
        paper.reload
